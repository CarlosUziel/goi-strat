...
python functional_analysis/run/rna_seq/multi_dataset/goi_gsva.py --threads 16 && \
python differential_expression/run/multi_dataset/goi_perc.py --threads 16 && \
python functional_analysis/run/rna_seq/multi_dataset/goi_perc.py --threads 16 && \
