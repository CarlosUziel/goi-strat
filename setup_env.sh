...
r-ashr r-gprofiler2 r-irkernel bioconductor-pathview bioconductor-sbgnview \
bioconductor-sesame bioconductor-sesamedata bioconductor-methylkit \
...
seaborn=0.12.2 fastcluster r-wgcna r-paralleldist bioconductor-biocparallel \
